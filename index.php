...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <p class="statusreadColor"><span>Status Read Sensor: </span><span id="ESP8266_01_Status_Read"></span></p>
        </div>
        <!-- ======================================================================================================= -->
        ...
        <div class="card">
          ...
          <h4 class="LEDColor" style="margin-top: 45px;"></h4>
          <label class="switch">
    ...
    <script>
      ...
      document.getElementById("ESP8266_01_Status_Read").innerHTML = "NN";
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp8266_01") {
              ...
              document.getElementById("ESP8266_01_Status_Read").innerHTML = myObj.status_read_sensor;
      ...
      function Update_LEDs(id,lednum,ledstate) {
        ...
        xmlhttp.open("POST","updateled.php",true);
        xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
