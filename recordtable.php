    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          // replace_with_your_table_name, on this project I use the table name 'esp8266_table_dht11_leds_record'.
          // This table is used to store and record DHT11 sensor data updated by ESP8266. 
          ...
          $sql = 'SELECT * FROM esp8266_table_dht11_leds_record ORDER BY date, time';
